...
Definition to_run_tr := compile_and_run_from_source_ex assign fuel.

Set Warnings "-extraction-reserved-identifier".
Extraction "/tmp/run_tagged_compiled_assign.ml" to_run_tr.

Require Import Merged Int32 I2MP.Examples.Helper.

Definition to_run_mr := @Merged.compile_and_run_from_source_merged_ex concrete_int_32_mt concrete_int_32_ops assign fuel.
(*
...
Definition to_run := compile_and_run_mp assign fuel.
