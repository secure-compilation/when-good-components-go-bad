...
Section Definability.
  ...
  Definition expr_of_event (C: Component.id) (P: Procedure.id) (e: event_inform) : expr :=
    ...
    | ERet  _ ret_val _ _ => E_deref (loc_of_reg E_R_COM)
    ...
    | ELoad cid r_src r_dest => E_assign (loc_of_reg r_dest) (E_deref (loc_of_reg r_src))
  ...
  Definition program_of_trace (t: trace event_inform) : program :=
    {| prog_interface  := intf;
