...
Section Simulation.
  ...
  Proof.
    ...
    inversion Hmerge as [ics ? ? Hmerge_iface Hfrom_initial Hpartial1 Hpartial2]; subst;
      ...
      inversion Hpartial2 as [? ? ? ? ? ? Hpc2 | ? ? ? ? ? ? Hcc2]; subst;
      PS.simplify_turn;
      [ destruct (domm_partition_in_neither Hmerge_iface Hfrom_initial Hpc1 Hpc2)
      |
    ...
    - apply PS.initial_state_intro
      ...
      + inversion H0 as [? ? ? ? ? ? ? Hmains1]; subst.
        ...
        * (* contra *)
          ...
          PS.simplify_turn.
          apply (domm_partition Hmerge_ifaces Hfrom_initial) in Hpc2.
...
Section PartialComposition.
  ...
  Proof.
    ...
    - intros ips2 Hmergeable Hst_star2.
      ...
      + destruct (domm_partition_in_neither Hmergeable_ifaces Hcomes_from Hpc1 Hpc2).
  ...
  Proof.
    ...
    - intros ips2 Hmergeable Hmt_star2.
      ...
      + (* Contra. *)
        PS.simplify_turn.
        apply (domm_partition Hsame_ifaces Hcomes_from) in Hpc2.
        rewrite Hpc2 in Hpc1.
        discriminate.
